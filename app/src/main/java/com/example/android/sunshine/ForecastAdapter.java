...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public int getHiTempToday(){
        mCursor.moveToFirst();
        return mCursor.getInt(MainActivity.INDEX_WEATHER_MAX_TEMP);
    }

    public int getLowTempToday(){
        mCursor.moveToFirst();
        return mCursor.getInt(MainActivity.INDEX_WEATHER_MIN_TEMP);
    }

    public int getConditionToday(){
        mCursor.moveToFirst();
        return mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID);
    }
